...
const InterviewReport = () => {
  ...
  const { report, getReportById, loading, getResumePdf, downloadingResume } =
    useResumeReport();
  ...
  return (
    <div className="min-h-screen w-full bg-[#0d1117] p-3 text-[#e6edf3] sm:p-4 md:p-6">
      <div className="mx-auto flex w-full max-w-7xl flex-col overflow-hidden rounded-2xl border border-[#2a3348] bg-[#161b22] lg:min-h-[calc(100vh-3rem)] lg:flex-row">
        {/* LEFT NAVIGATION */}
        <nav className="flex w-full shrink-0 flex-col justify-between gap-1 border-b border-[#2a3348] p-4 sm:p-5 lg:w-55 lg:border-b-0 lg:p-7 lg:px-4">
          <div>
          ...
          <div className="mt-4 lg:mt-0 w-full">
            <div className="flex items-start gap-2.5 md:gap-1 rounded-lg border border-[#2d4a7a] bg-[#1b2a4a] px-4 py-3 md:px-3 md:py-1.5 mb-1 mt-2">
              ...
              <p className="m-0 text-xs leading-relaxed text-[#8ab4f8]">
                Your refined resume is ready. It was generated based on the
            ...
            <button
              ...
              className="primary-button flex w-full items-center justify-center disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {downloadingResume ? (
                <Loader />
              ) : (
          ...
          {activeNav === "roadmap" && (
            <section className="min-h-full">
              ...
              <div className="relative flex flex-col">
                {/* Timeline */}
                <span className="absolute bottom-0 left-[27px] top-0 w-0.5 rounded-full bg-linear-to-b from-[#ff2d78] to-[#ff2d78]/10" />
        ...
        {/* RIGHT SIDEBAR */}
        <aside className="flex w-full shrink-0 flex-col gap-5 border-t border-[#2a3348] p-5 sm:p-6 lg:w-60 lg:border-t-0 lg:p-7 lg:px-5">
          {/* Match Score */}
            ...
            <div className="flex flex-wrap gap-2">
              {report.skillGaps.map((gap, i) => {
                const severityClasses = {
                  ...
                  medium: "border-[#f5a623]/25 bg-[#f5a623]/10 text-[#f5a623]",
